...
function App() {
  ...
  const init = async () => {
    ...
    console.log('Không chạm tay vào mặt và bấm Train 1 ');
  ...
  const run = async ()=> {
    ...
    if(result.label === TOUCHED_LABEL && result.confidences[result.label]> TOUCH_CONFIDENT){
      console.log('Touched');
